...
TaskForge is a daily interview preparation tracker for developers/software engineers. It includes a React + TypeScript + Vite frontend and a FastAPI backend with Supabase/Postgres persistence.
